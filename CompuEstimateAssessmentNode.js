CompuEstimateAssessmentNode.prototype = new Node();
CompuEstimateAssessmentNode.prototype.constructor = CompuEstimateAssessmentNode;
CompuEstimateAssessmentNode.prototype.parent = Node.prototype;

/*
 * the name that displays in the authoring tool when the author creates a new step
 */
CompuEstimateAssessmentNode.authoringToolName = "CompuEstimateAssessment"; 

/*
 * will be seen by the author when they add a new step to their project to help
 * them understand what kind of step this is
 */
CompuEstimateAssessmentNode.authoringToolDescription = "This is a generic step only used by developers";
 ...
 * @param view
 */
function CompuEstimateAssessmentNode(nodeType, view) {
	this.view = view;
	this.type = nodeType;
 ...
 */
CompuEstimateAssessmentNode.prototype.parseDataJSONObj = function(stateJSONObj) {
	return CompuEstimateAssessmentState.prototype.parseDataJSONObj(stateJSONObj);
};
 ...
 */
CompuEstimateAssessmentNode.prototype.translateStudentWork = function(studentWork) {
	return studentWork;
};
 ...
 */
CompuEstimateAssessmentNode.prototype.onExit = function() {
 ...
 */
CompuEstimateAssessmentNode.prototype.renderGradingView = function(divId, nodeVisit, childDivIdPrefix, workgroupId) {
	//Get the latest student state object for this step
	var compuEstimateAssessmentState = nodeVisit.getLatestWork();
	...
	var studentWork = compuEstimateAssessmentState.getStudentWork();
 ...
 */
CompuEstimateAssessmentNode.prototype.getHTMLContentTemplate = function() {
	return createContent('node/compuEstimateAssessment/compuEstimateAssessment.html');
};

//Add this node to the node factory so the vle knows it exists.
NodeFactory.addNode('CompuEstimateAssessmentNode', CompuEstimateAssessmentNode);

//used to notify scriptloader that this script has finished loading
if(typeof eventManager != 'undefined'){
	eventManager.fire('scriptLoaded', 'vle/node/compuEstimateAssessment/CompuEstimateAssessmentNode.js');
};