/**
 * Sets the CompuEstimateAssessmentNode type as an object of this view
 */
View.prototype.CompuEstimateAssessmentNode = {};
 ...
 */
View.prototype.CompuEstimateAssessmentNode.commonComponents = [];
 ...
 */
View.prototype.CompuEstimateAssessmentNode.generatePage = function(view){
	this.view = view;
	 ...
	 * 
	 * onkeyup will fire the 'compuEstimateAssessmentUpdatePrompt' event which will
	 * be handled in the compuEstimateAssessmentEvents.js file
	 * 
	 * when you add new authoring components, you will need to create
	 * new events in the compuEstimateAssessmentEvents.js file and then
	 * create new functions to handle the event
	 */
	var promptTextArea = createElement(document, 'textarea', {id: 'promptTextArea', rows:'20', cols:'85', onkeyup:"eventManager.fire('compuEstimateAssessmentUpdatePrompt')"});
 ...
 */
View.prototype.CompuEstimateAssessmentNode.getCommonComponents = function() {
 ...
 */
View.prototype.CompuEstimateAssessmentNode.updateContent = function(){
 ...
 */
View.prototype.CompuEstimateAssessmentNode.populatePrompt = function() {
 ...
 */
View.prototype.CompuEstimateAssessmentNode.updatePrompt = function(){
	/* update content */
...
if(typeof eventManager != 'undefined'){
	eventManager.fire('scriptLoaded', 'vle/node/compuEstimateAssessment/authorview_compuEstimateAssessment.js');
};